//
//  CueInfoActivationViewController.m
//  SEMCRM
//
//  Created by Sem on 2018/2/28.
//  Copyright © 2018年 sem. All rights reserved.
//

#import "CueInfoActivationViewController.h"
#import "CarsChooseViewController.h"
@interface CueInfoActivationViewController ()<CarsChooseDelegate>
@property (weak, nonatomic) IBOutlet UIBarButtonItem *commit;
...
@implementation CueInfoActivationViewController
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender {
    ...
    if ([view respondsToSelector:@selector(setCueModel:)]) {
        [view setValue:_cueModel forKey:@"cueModel"];
    }
