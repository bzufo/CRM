...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    if(![[NSUserDefaults standardUserDefaults] boolForKey:@"firstStart"]){
        ...
        NSLog(@"第一次启动");
        NSArray *arr =@[@{@"title":@"默认模板",@"subtitle":@"XXX先生/女士，您好！感谢您对东南DX7车型的关注，欢迎您莅临我们的4S店看车试驾。因无法接通您的电话，请您看到留言后抽空给我回电，我会竭诚为您提供周到的购车咨询服务。"},@{@"title":@"自定义模板1",@"subtitle":@"XXX先生/女士，您好！"},@{@"title":@"自定义模板2",@"subtitle":@"XXX先生/女士，您好！"}];
        [[NSUserDefaults standardUserDefaults] setObject:arr forKey:@"msg"];
        
    }else{
        NSLog(@"不是第一次启动");
    }
//    BOOL ss=[MyUtil isValidateTelephone:@"17570978915"];
    [UMessage startWithAppkey:@"56aeb4b467e58e14340013c8" launchOptions:launchOptions];
    //注册通知
...
- (NSURL *)applicationDocumentsDirectory {
    // The directory the application uses to store the Core Data store file. This code uses a directory named "com.soueast-motor..SEMCRM" in the application's documents directory.
...
- (NSManagedObjectModel *)managedObjectModel {
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"SEMCRM" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator {
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"SEMCRM.sqlite"];
    NSError *error = nil;
